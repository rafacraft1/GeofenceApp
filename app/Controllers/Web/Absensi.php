...
{
    // $this->db sudah diinisialisasi secara otomatis oleh BaseController
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'kelas_aktif' => $kelasFilter, // Key array tetap dipertahankan agar View tidak rusak
            'absensi'     => $absensi,
            'siswa'       => $siswa,
    ...
    public function inputManual()
    {
        ...
        $siswa = $this->db->table('siswa')->where('id_siswa', $siswaId)->get()->getRowArray();
