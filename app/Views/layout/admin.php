...
<body class="bg-gray-50 font-sans antialiased flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="bg-slate-900 text-slate-300 w-64 flex-shrink-0 fixed md:relative inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out z-50 flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
            ...
            <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mt-4 mb-2">Master Data</p>
            ...
            <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mt-4 mb-2">Operasional</p>
            ...
            <p class="px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider mt-4 mb-2">Sistem</p>
            ...
            <a href="/admin/log-fraud" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors <?= $segment == 'log-fraud' ? 'bg-blue-600 text-white shadow-md' : 'hover:bg-slate-800 hover:text-white' ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
