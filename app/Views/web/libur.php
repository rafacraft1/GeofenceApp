        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form action="<?= base_url('admin/libur/store') ?>" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="keterangan" rows="3" required placeholder="Misal: Libur Semester Genap"
                ...
                <button type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-sm transition-colors flex justify-center items-center">
                        ...
                        <?php else : ?>
                            ...
                            foreach ($daftar_libur as $libur) : ?>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors <?= $is_passed ? 'opacity-60' : '' ?>">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="h-8 w-8 rounded bg-<?= $is_passed ? 'gray' : 'red' ?>-100 flex items-center justify-center text-<?= $is_passed ? 'gray' : 'red' ?>-600 mr-3 font-bold text-xs">
                                                <?= $date->format('d') ?>
                                            </div>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600">
                                        ...
                                        <?php if ($is_passed): ?>
                                            <span class="ml-2 text-[10px] bg-gray-200 text-gray-600 px-2 py-0.5 rounded-full">Selesai</span>
                                        <?php endif; ?>
                                    </td>
