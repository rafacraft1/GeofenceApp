...
<div class="max-w-3xl mx-auto">
    <div class="mb-6 flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola identitas aplikasi dan kontrol versi pembaruan APK.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-10 flex flex-col relative overflow-hidden">
        ...
        <div class="absolute top-6 right-6 z-10 pointer-events-none">
            <?php if ($isFirebaseEmpty): ?>
                <div class="bg-red-50 border border-red-100 px-3 py-2 flex items-center gap-2 rounded-xl shadow-sm" title="Silakan konfigurasi Firebase di file .env Anda">
